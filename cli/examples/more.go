...
func mxTest(ctx context.Context, cmd *cli.Command, args []string) (err error) {
	_, _ = cmd, args
	// cmdr.Set("test.1", 8)
...
func xyPrint(ctx context.Context, cmd *cli.Command, args []string) (err error) {
	//
...
func kbPrint(ctx context.Context, cmd *cli.Command, args []string) (err error) {
...
func soundex(ctx context.Context, cmd *cli.Command, args []string) (err error) {
	_, _ = cmd, args
	for ix, s := range args {
		fmt.Printf("%5d. %s => %s\n", ix, s, text.Soundex(s))
	}
...
func ttySize(ctx context.Context, cmd *cli.Command, args []string) (err error) {
	_, _ = cmd, args
