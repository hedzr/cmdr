...
type taskAfterRun func(ctx context.Context, w *workerS, pc *parseCtx, errRan error, sb *strings.Builder) (err error)
...
func (w *workerS) Actions() (ret map[string]bool) {
	...
	if e&cli.ActionRunHelpSystem != 0 {
		ret["run-help-system"] = true
	}
...
func (w *workerS) Ready() bool {
	w.actions = map[cli.ActionEnum]onAction{
		...
		cli.ActionRunHelpSystem:       w.runHelpSystem,
