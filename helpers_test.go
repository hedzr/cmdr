...
func resetFlagsAndLog(t *testing.T) {
	...
	t.Log(cmdr.GetBool("app.debug", false))
	t.Log(cmdr.GetBoolR("debug", false))
	t.Log(cmdr.GetBoolRP("", "debug", false))
	t.Log(cmdr.GetBoolP("app", "debug", false))
	...
	t.Log(cmdr.GetInt("app.retry", 1))
	t.Log(cmdr.GetIntR("retry", 1))
	t.Log(cmdr.GetIntRP("", "retry", 1))
	t.Log(cmdr.GetIntP("app", "retry", 1))
	t.Log(cmdr.GetInt64("app.retry", 1))
	t.Log(cmdr.GetInt64R("retry", 1))
	t.Log(cmdr.GetInt64RP("", "retry", 1))
	t.Log(cmdr.GetInt64P("app", "retry", 1))
	...
	t.Log(cmdr.GetUint("app.retry", 1))
	t.Log(cmdr.GetUintP("app", "retry", 1))
	t.Log(cmdr.GetUintR("retry", 1))
	t.Log(cmdr.GetUintRP("", "retry", 1))
	t.Log(cmdr.GetUint64("app.retry", 1))
	t.Log(cmdr.GetUint64R("retry", 1))
	t.Log(cmdr.GetUint64RP("", "retry", 1))
	t.Log(cmdr.GetUint64P("app", "retry", 1))
	...
	t.Log(cmdr.GetFloat32("app.retry", 1))
	t.Log(cmdr.GetFloat32P("app", "retry", 1))
	t.Log(cmdr.GetFloat32R("retry", 1))
	t.Log(cmdr.GetFloat32RP("", "retry", 1))
	t.Log(cmdr.GetFloat32P("app", "retry", 1))
	t.Log(cmdr.GetFloat64("app.retry", 1))
	t.Log(cmdr.GetFloat64R("retry", 1))
	t.Log(cmdr.GetFloat64RP("", "retry", 1))
	t.Log(cmdr.GetFloat64P("app", "retry", 1))
	...
	t.Log(cmdr.GetDuration("app.ms.tags.modify.v", time.Second))
	t.Log(cmdr.GetDurationP("app", "ms.tags.modify.v", time.Second))
	t.Log(cmdr.GetDurationR("ms.tags.modify.v", time.Second))
	t.Log(cmdr.GetDurationRP("ms.tags", "modify.v", time.Second))
